...
<script src = "/secure/lang/servlets/js/driver-4.js"type = "text/javascript"></script>
<title>JDBC Driver-4</title>
<style>
...
.blinking-border-background-purple {
	animation: blink-border-background-purple 1.0s linear 1;
}

@keyframes blink-border-background-purple {
	...
	75% {
		box-shadow:  0 2px 6px 2px purple;
	}
 ...
 <div>
	...
	<div class="col-xs-offset-1 col-xs-9 main-div text margin-top20"
		...
		<div  class="col-xs-offset-4 col-xs-8 animation-div border margin-top20"
			...
			<div 
			class="border shadow text-center opacity00" id="callJavaBox"
			...
			<div class="col-xs-12 margin-top20" style="margin: 0px;">
				<svg width="100%" height="50" class="col-xs-12 text">
			...
			<!-- <div class = "col-xs-12 margin-top20"></div> -->
				<div class = "col-xs-offset-4 col-xs-4 text">
				<div class = "border shadow text-centeer margine-top20 opacity00 " id = "thintype"
				style = "background-color: lightyellow;">
						<b> &emsp; Thin(Type4) JDBC <center>Driver</center></b> 
				</div>
				</div>
				<div class="col-xs-12 margin-top20" style="margin: 0px;">
