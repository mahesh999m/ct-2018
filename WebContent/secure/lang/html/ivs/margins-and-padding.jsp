	...
	intro.onafterchange(function(targetElement) {
		...
		switch (elementId) {
			...
			case "pTagText" :
				...
				$('.introjs-helperLayer').one('transitionend', function () {
					$('.introjs-tooltip').removeClass('hide');
					text = 'Enter <span class="ct-code-b-yellow">Apply borders, margin and padding</span>';
					typing('.introjs-tooltiptext', text, function() {
						$("#pTagText").focus();
						nextSteps("#htmlDisplay", "displayPtag");
						textValidation("#pTagText", "Apply borders, margin and padding");
					});
				});
			break;
...
<span id="styleCloseTag">&lt;/style&gt;</span></div>
	<span id="bodyOpenTag">&lt;body&gt; </span>
		<div id="ptag" style="display: -moz-inline-box"><input id="pTagOpen" type="text" size="3" maxlength='3'>
...
<span id="hClosedTag">&lt;/html&gt;</span>
				...
				<div class="col-xs-6">
					<div class = "col-xs-12 padding00" id = "htmlDisplay">
						<div>
							<img id="image1" class="image-custom1" src="/images/borders.png">
						</div>
						<div class ="col-xs-12 html-body" id = "htmlBody">
							<span id = "pcontent" class="opacity00">Apply margins and paddings</span>
						</div>
					</div>
				</div>
			</div>
