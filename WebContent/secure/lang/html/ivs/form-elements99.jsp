...
function introGuide() {
	...
	introjs.onafterchange(function(targetElement) {
		...
		case "label12":
			...
			$('.introjs-prevbutton').hide();
			$(".introjs-helperLayer").one("transitionend", function() {
				var text = 'Enter &lt;/label&gt; close tag.';
				typing($(".introjs-tooltiptext"), text, function() {
		...
		case "labelBody2":
			...
			$('.introjs-prevbutton').hide();
			$(".introjs-helperLayer").one("transitionend", function() {
				var text = 'Enter Select Account type:.';
				typing($(".introjs-tooltiptext"), text, function() {
		...
		case "totalSelect":
			...
			$('.introjs-prevbutton').hide();
			$(".introjs-helperLayer").one("transitionend", function() {
				var text = "Let us create select. &lt;select&gt; element is used to create a drop-down list.";
				introjs.refresh();
				typing($(".introjs-tooltiptext"), text, function() {
		...
		case "selectName":
			...
			$('.introjs-prevbutton').hide();
			$(".introjs-helperLayer").one("transitionend", function() {
				var text = 'Defines a name for the drop-down list. Enter name="accountType".';
				typing($(".introjs-tooltiptext"), text, function() {
		...
		case "option1Value":
			...
			$('.introjs-prevbutton').hide();
			$(".introjs-helperLayer").one("transitionend", function() {
				var text = 'Enter value="Savings Account". The &lt;option&gt; tag can be used without any attributes, but you usually need the value attribute, which indicates what is sent to the server.';
				typing($(".introjs-tooltiptext"), text, function() {
		...
		case "option1Body":
			...
			$('.introjs-prevbutton').hide();
			$(".introjs-helperLayer").one("transitionend", function() {
				var text = 'Enter Savings Account.';
				typing($(".introjs-tooltiptext"), text, function() {
		...
		case "option2Value":
			...
			$('.introjs-prevbutton').hide();
			$(".introjs-helperLayer").one("transitionend", function() {
				var text = 'Enter value="Current Account". The &lt;option&gt; tag can be used without any attributes, but you usually need the value attribute, which indicates what is sent to the server.';
				typing($(".introjs-tooltiptext"), text, function() {
		...
		case "option2Body":
			...
			$('.introjs-prevbutton').hide();
			$(".introjs-helperLayer").one("transitionend", function() {
				var text = 'Enter Current Account.';
				typing($(".introjs-tooltiptext"), text, function() {
		...
		case "option3Value":
			...
			$('.introjs-prevbutton').hide();
			$(".introjs-helperLayer").one("transitionend", function() {
				var text = 'Enter value="Women Saving Account". The &lt;option&gt; tag can be used without any attributes, but you usually need the value attribute, which indicates what is sent to the server.';
				typing($(".introjs-tooltiptext"), text, function() {
		...
		case "option3Body":
			...
			$('.introjs-prevbutton').hide();
			$(".introjs-helperLayer").one("transitionend", function() {
				var text = 'Enter Women Saving Account.';
				typing($(".introjs-tooltiptext"), text, function() {
		...
		case "option4Value":
			...
			$('.introjs-prevbutton').hide();
			$(".introjs-helperLayer").one("transitionend", function() {
				var text = 'Enter value="Salary Account". The &lt;option&gt; tag can be used without any attributes, but you usually need the value attribute, which indicates what is sent to the server.';
				typing($(".introjs-tooltiptext"), text, function() {
		...
		case "option5Value":
			...
			$('.introjs-prevbutton').hide();
			$(".introjs-helperLayer").one("transitionend", function() {
				var text = 'Enter value="NRO Saving Account". The &lt;option&gt; tag can be used without any attributes, but you usually need the value attribute, which indicates what is sent to the server.';
				typing($(".introjs-tooltiptext"), text, function() {
		...
		case "option5Body":
			...
			$('.introjs-prevbutton').hide();
			$(".introjs-helperLayer").one("transitionend", function() {
				var text = 'Enter NRO Saving Account.';
				typing($(".introjs-tooltiptext"), text, function() {
		...
		case "optLabel1":
			...
			$('.introjs-prevbutton').hide();
			$(".introjs-helperLayer").one("transitionend", function() {
				var text = 'Enter label="Domestic". The label attribute specifies a label for an option-group. Let us create another optgroup.';
				typing($(".introjs-tooltiptext"), text, function() {
		...
		case "optLabel2":
			...
			$('.introjs-prevbutton').hide();
			$(".introjs-helperLayer").one("transitionend", function() {
				var text = 'Enter label="NRI". The label attribute specifies a label for an option-group.';
				typing($(".introjs-tooltiptext"), text, function() {
		...
		case "fieldset1":
			...
			$('.introjs-prevbutton').hide();
			$(".introjs-helperLayer").one("transitionend", function() {
				var text = 'Let us create fieldset. Fieldset is used to group related elements in a form. Enter &lt;fieldset&gt; open tag.';
				typing($(".introjs-tooltiptext"), text, function() {
		...
		case "fieldset2":
			...
			$('.introjs-prevbutton').hide();
			$(".introjs-helperLayer").one("transitionend", function() {
				var text = 'Enter &lt;/fieldset&gt; close tag.';
				typing($(".introjs-tooltiptext"), text, function() {
		...
		case "legend1":
			...
			$('.introjs-prevbutton').hide();
			$(".introjs-helperLayer").one("transitionend", function() {
				var text = '&lt;legend&gt; defines a caption for the &lt;legend&gt; element. Enter &lt;legend&gt; open tag.';
				typing($(".introjs-tooltiptext"), text, function() {
		...
		case "legend2":
			...
			$('.introjs-prevbutton').hide();
			$(".introjs-helperLayer").one("transitionend", function() {
				var text = 'Enter &lt;/legend&gt; close tag.';
				typing($(".introjs-tooltiptext"), text, function() {
		...
		case "legendBody":
			...
			$('.introjs-prevbutton').hide();
			$(".introjs-helperLayer").one("transitionend", function() {
				var text = 'Enter Address For Communication.';
				typing($(".introjs-tooltiptext"), text, function() {
		...
		case "browser":
			if (introjs._currentStep == 7) {
				...
				$(".introjs-helperLayer").one("transitionend", function() {
					...
					typing(".introjs-tooltiptext", text, function() {
						$("#outputDiv > span:last-child").append("<span><select><optgroup label="+ $("#optLabel1Text").val() +">"
										+ "<option>"+$("#option1Val").val()+"</option>"
										+ "<option>"+$("#option2Val").val()+"</option>"
										+ "<option>"+$("#option3Val").val()+"</option>"
										+ "</optgroup>"
										+ "<optgroup label='" + $("#optLabel2Text").val() + "'>"
										+ "<option>"+$("#option4Val").val()+"</option>"
										+ "<option>"+$("#option5Val").val()+"</option>"
...
function codetantra() {
	/* setTimeout(function(){
		$("#spinArrow").removeClass("hide");
		$("#notSpinpinArrow").addClass("hide");
	}, 1000); */
...
/* 	if($("select").last().val() == "C Language") {
		$("#outputDiv2 > div:last-child").append("<div><p>In the C Programming course you will learn:<br> Basics - This section covers all the fundamentals of C programming"
		 +" language like, Operators, Data Types, Control Flow statements, Arrays.<br>Advanced - This section covers Text processing, Functions, Storage classes, Recursion,"
		 + " Pointers, Structures and Unions and Files.</p></div>")
	} else if($("select").last().val() == "Java") {
		$("#outputDiv2 > div:last-child").append("<div><p>In the Java Programmer course you will learn: <br>Java - This section covers all the fundamentals of Java programming language."
				+ "Advanced Java - This section covers multi-threading, IO and other features in Java.</p></div>")
	} else if($("select").last().val() == "Selenium") {
		$("#outputDiv2 > div:last-child").append("<div><p> This section teaches how to write Automated Test Code using Selenium WebDriver in Java.</p></div>")
	}
	 else if($("select").last().val() == "HTML") {
			$("#outputDiv2 > div:last-child").append("<div><p> This section covers all the fundamentals of HTML.</p></div>")
	}
	 else if($("select").last().val() == "CSS") {
			$("#outputDiv2 > div:last-child").append("<div><p> This section covers all the fundamentals of CSS.</p></div>")
	} */
		...
		<div id="code" class="opacity00">
			<span id="htmlOpenTag" class="opacity00">&lt;html&gt;</span><br>
				...
				<span id="headCloseTag" class="opacity00">&lt;/head&gt;</span><br>
					...
					&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<span id="totalOptgroup1"><span id="optgroupOpenTag1" class="opacity00">&lt;optgroup <span id="optLabel1" class="hide">label="<input id="optLabel1Text" class="hide input-css5" maxlength='8' originalText="Domestic">"</span>&gt;</span><br>
					...
					&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<span id="totalOptgroup2"><span id="optgroupOpenTag2" class="opacity00">&lt;optgroup <span id="optLabel2" class="hide">label="<input id="optLabel2Text" class="hide input-css4" maxlength='3' originalText="NRI">"</span>&gt;</span><br>
