		...
		switch(elementId) {
				...
				$('.introjs-helperLayer').one('transitionend', function() {
					if (introjs._currentStep == 2) {
						$("#h1Tag").addClass("z-index").effect("highlight", {color: "yellow"}).effect("transfer", {to: $("#h1Browser"), className: "ui-effects-transfer"}, 1500, function() {
							...
							$("#h1StyleTag").append('<span id="h1Selector"> <span id="h1Enter" contenteditable="false" maxlength="2" spellcheck="false"></span> </span>');
			...
			case "h1Selector":
				...
				$('.introjs-helperLayer').one('transitionend', function() {
					...
					typing('.introjs-tooltiptext', text, function() {
						$("#h1StyleTag").append('<span id="h1Open"> <span id="h1OpenBrace" contenteditable="false" maxlength="1" spellcheck="false"></span> </span>');
	 					$("#h1StyleTag").append('<br>\t\t\t\t<span id="h1Coloring"> <span id="h1Color" contenteditable="false" maxlength="13" spellcheck="false"></span> </span><br>'
	 										+ '\t\t\t<span id="h1Close"> <span id="h1CloseBrace" contenteditable="false" maxlength="1" spellcheck="false"></span> </span>');
	 					nextStep("#h1Open");
			...
			case "h2Selector":
				...
				$('.introjs-helperLayer').one('transitionend', function() {
					...
					typing('.introjs-tooltiptext', text, function() {
						$("#h2Style").append('<span id="h2Open"> <span id="h2OpenBrace" contenteditable="false" maxlength="1" spellcheck="false"></span> </span>'
								+ '<br>\t\t\t\t<span id="h2Coloring"> <span id="h2Color" contenteditable="false" maxlength="11" spellcheck="false"></span> </span><br>'
								+ '\t\t\t\t<span id="fontType"> <span id="fontFmly" contenteditable="false" maxlength="23" spellcheck="false"></span> </span><br>'
								+ '\t\t\t\t<span id="alignment"> <span id="alignType" contenteditable="false" maxlength="19" spellcheck="false"></span> </span><br>'
								+ '\t\t\t<span id="h2Close"> <span id="h2CloseBrace" contenteditable="false" maxlength="1" spellcheck="false"></span> </span>')
						nextStep("#h2Open");
			...
			case "h3Selector":
				...
				$('.introjs-helperLayer').one('transitionend', function() {
					if (introjs._currentStep == 17) {
						...
						typing('.introjs-tooltiptext', text, function() {
							$("#h3Style").append('<span id="h3Open"> <span id="h3OpenBrace" contenteditable="false" maxlength="1" spellcheck="false"></span> </span>'
											+ '<br>\t\t\t\t<span id="h3Background"> <span id="h3Color" contenteditable="false" maxlength="25" spellcheck="false"></span> </span>'
											+ '<br>\t\t\t<span id="h3Close"> <span id="h3CloseBrace" contenteditable="false" maxlength="1" spellcheck="false"></span> </span>');
							nextStep("#h3Open");
						...
						typing('.introjs-tooltiptext', text, function() {
		                    ...
		                    $("#h3Enter").text('');
		                   	$("#h3Enter").off();
		                    $("#h3Enter").append('h3<span id="h3CommaEnter" contenteditable="false" maxlength="4" spellcheck="false"></span> ');
				...
				$('.introjs-helperLayer').one('transitionend', function() {
					...
					var text = "Let us create <span class='ct-code-b-yellow'>h5</span> selector in style tag.<br>Enter <span class='ct-code-b-yellow'>h5</span>";
						...
						typing('.introjs-tooltiptext', text, function() {
							$("#h5Enter").text('');
							$("#h5Enter").off();
							$("#h5Enter").append('h5<span id="h5CommaEnter" contenteditable="false" spellcheck="false" maxlength="4"></span> ');
...
function userButton() {
	...
	if (count == 1) {
		...
		$("#h1Color").effect("transfer", {to: $("#h1Browser"), className: "ui-effects-transfer"}, 1500, function() {
			...
			$("#h1Tag").append('<br><div id="h2Tag" class="opacity00" style="display: inline-block;">&lt;h2&gt;h2 is smaller than h1&lt;/h2&gt;</div>');
			nextStep("#h2Tag");
			$('.introjs-nextbutton').show();
		});
	} else if (count == 2) {
		...
		$("#alignType").effect("transfer", {to: ($("#h2Browser").parent()), className: "ui-effects-transfer"}, 1500, function() {
			...
			$("#h2Tag").append('<br><div id="h3Tag" class="opacity00">&lt;h3&gt;>h3 is smaller than h2&lt;/h3&gt;</div>');
			nextStep("#h3Tag");
			$('.introjs-nextbutton').show();
		});
	} else if (count == 5) {
		...
		$("#h3Color").effect("transfer", {to: ($("#h3Browser").parent()), className: "ui-effects-transfer"}, 1500, function() {
			...
			$("#h3Tag").append('<br><div id="h4Tag" class="opacity00">&lt;h4&gt;h4 is smaller than h3&lt;/h4&gt;</div>');
			nextStep('#h4Tag');
			$('.introjs-nextbutton').show();
		});
	} else if (count == 6) {
		...
		$("#h3Color").effect("transfer", {to: ($("#h4Browser").parent()), className: "ui-effects-transfer"}, 1500, function() {
			...
			$("#h4Tag").append('<br><div id="h5Tag" class="opacity00">&lt;h5&gt;h5 is smaller than h4&lt;/h5&gt;</div>');
			nextStep('#h5Tag');
			$('.introjs-nextbutton').show();
		});
	} else if (count == 7) {
		...
		$("#h5Align").effect("transfer", {to: ($("#h5Browser").parent()), className: "ui-effects-transfer"}, 1500, function() {
			...
			$("#h5Tag").append('<br><div id="h6Tag" class="opacity00">&lt;h6&gt;h6 is smaller than h5&lt;/h6&gt;</div>');
			nextStep("#h6Tag");
			$('.introjs-nextbutton').show();
		});
	} else if (count == 11) {
...
function browserSteps() {
	if (introjs._currentStep == 8) {
		$("#h2Tag").addClass("z-index").effect("transfer", {to: $("#h2Browser"), className: "ui-effects-transfer"}, 1500, function() {
			...
			$("#h2Style").append('\t\t\t<span id="h2Selector"> <span id="h2Enter" contenteditable="false" maxlength="2" spellcheck="false"></span> </span>');
		...
		$("#h3Tag").addClass("z-index").effect("transfer", {to: $("#h3Browser"), className: "ui-effects-transfer"}, 1500, function() {
			...
			$("#h3Style").append('\t\t\t<span id="h3Selector"> <span id="h3Enter" contenteditable="false" maxlength="2" spellcheck="false"></span> </span>');
		...
		$("#h5Tag").addClass("z-index").effect("transfer", {to: $("#h5Browser"), className: "ui-effects-transfer"}, 1500, function() {
			...
			$("#h5Style").append('\t\t\t<span id="h5Selector"> <span id="h5Enter" contenteditable="false" maxlength="24" spellcheck="false"></span> </span>'
					+ '<span id="h5Open"> <span id="h5OpenBrace" contenteditable="false" maxlength="1" spellcheck="false"></span> </span><br>'
					+ '\t\t\t\t<span id="h5Bordering"> <span id="h5Border" contenteditable="false" maxlength="24" spellcheck="false"></span> </span><br>'
					+ '\t\t\t\t<span id="h5Coloring"> <span id="h5Color" contenteditable="false" maxlength="13" spellcheck="false"></span> </span><br>'
					+ '\t\t\t\t<span id="h5fontFmly"> <span id="h5FontType" contenteditable="false" maxlength="23" spellcheck="false"></span> </span><br>'
					+ '\t\t\t\t<span id="h5Alignment"> <span id="h5Align" contenteditable="false" maxlength="18" spellcheck="false"></span> </span><br>'
					+ '\t\t\t<span id="h5Close"><span id="h5CloseBrace" contenteditable="false" maxlength="1" spellcheck="false"></span> </span>');
...
<span id="htmlOpen" class="opacity00">&lt;html&gt;</span>
	...
	<span id="bodyOpen" class="opacity00">&lt;body&gt;</span>
		<div id="h1Tag" class="opacity00" style="display: inline-block;">&lt;h1&gt;This is first heading&lt;/h1&gt;</div> 
	<span id="bodyClose" class="opacity00">&lt;/body&gt;</span> 
<span id="htmlClose" class="opacity00">&lt;/html&gt;</span>
</pre>
			<div class="col-xs-6 col-xs-offset-2 padding0 opacity00" id="browser">
				<div class="col-xs-12 padding0">
					<img src="/images/internal-with-attributes.png">
					<div style="border: 1px solid black; padding-left: 8px;">
