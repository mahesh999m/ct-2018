...
<span id="styleCloseTag">&lt;/style&gt;</span></div>
	<span id="bodyOpenTag">&lt;body&gt; </span>
		<div id="htag" style="display: -moz-inline-box"><input id="hTagOpen" type="text" size="4" maxlength='4'>
		<input id="hTagText" type="text" size="20" maxlength='20'>
		<input id="hTagClose" type="text" size="5" maxlength='5'></div>
