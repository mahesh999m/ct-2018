...
$(document).ready(function() {
	...
	intro.onafterchange(function(targetElement) {
		...
		switch (elementId) {
			...
			case "openCurlyBrace" :
				$('.introjs-nextbutton, .introjs-prevbutton, .introjs-skipbutton').hide();
				$("#openCurlyBrace").after('<br><input id="closeCurlyBrace" type="text" size="3" maxlength="3">');
			...
			case "closeCurlyBrace" :
				$('.introjs-nextbutton, .introjs-prevbutton, .introjs-skipbutton').hide();
				$("#openCurlyBrace").after('<br>\t<span id="align"><input id="textAlignment'+ buttonCount+'" type="text" size="11" maxlength="11"></span>');
			...
			case "applyCss" :
				...
				if (buttonCount <= 6) {
					if (buttonCount == 2) {
						$("#align").after('<br>\t<span id="indent'+buttonCount +'"><input id="textAlignment'+ buttonCount+'" type="text" size="11" maxlength="11"></span>');
					} else {
						$("#indent"+ (buttonCount -1)).after('<br>\t<span id="indent'+buttonCount +'"><input id="textAlignment'+ buttonCount+'" type="text" size="15" maxlength="15"></span>');
					}
				}
...
<span class='border10 opacity00' id="styleCloseTag">&lt;/style&gt;</span></div>
	...
	<div id="divTag" style="display: -moz-inline-box"><input id="divTagOpen" type="text" size="4" maxlength='4'>
		<input id="divTagText" type="text" size="20" maxlength='20'>
		<input id="divTagClose" type="text" size="4" maxlength='4'></div>
				...
				<div class="col-xs-6 col-xs-offset-1">
					<div class = "col-xs-12" id = "htmlDisplay">
						...
						<div class ="col-xs-12 html-body" id = "htmlBody">
							<div id = "pcontent" class="opacity00">This is a DIV tag.</div><br>
						</div>
					</div>
				</div>
			</div>
