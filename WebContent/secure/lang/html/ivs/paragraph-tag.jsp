...
var pTagText = ['I am a Developer.', 'I work in CodeTantra.', 'You are learning Wed Designing.'];
		...
		switch (elementId) {
			...
			case "divTagText" + inputFieldCount :
				...
				if (inputFieldCount == 1) {
					$("#divTag").append('<br><span id="spanCount'+ (inputFieldCount + 1) +'"><input id="divTagText'+ (inputFieldCount + 1) +
							'" type="text" size="21" maxlength="21"></span>');					
				} else if(inputFieldCount == 2) {
					$("#divTag").append('<br><span id="spanCount'+ (inputFieldCount + 1) +'"><input id="divTagText'+ (inputFieldCount + 1) +
						'" type="text" size="31" maxlength="31"></span>');
				} 
...
<span id="hOpenTag"> &lt;html&gt; </span>
	...
	<span id="bodyOpenTag">&lt;body&gt; </span>
		<div id="divTag" style="display: inline-block; position: relative;"><span id='spanCount1'><input id="divTagText1" type="text" size="18" maxlength='18'></span></div>
				...
				<div class='container' id = "htmlDisplay">
					...
					<div class ="col-xs-12 html-body" id = "htmlBody">
						<div id="outputText" class="opacity00">
							...
							<span id = "pTagOutput3">You are learning Wed Designing.</span>
						</div>
					</div>
				</div>
			</div>
