		...
		case "line1" :
			...
			$('.introjs-helperLayer ').one('transitionend', function() {
				typing(".introjs-tooltiptext", "<span class='ct-code-b-yellow'>main()</span> is the operating system call."
						+"<br><br><span class='ct-code-b-yellow'>main()</span> is execution starting point for any <span "
						+"class='ct-code-b-yellow'>C</span> program.", 10, "",function() {
